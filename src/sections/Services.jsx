...
function Services() {
  const text =
    "I build secure, high-performance full-stack apps with smoothUX to drive groth not headaches.";
        ...
        >
          <div className="flex items-center justify-between gap-4 font-light">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-xl leading-relaxed tracking-widest lg:text-2xl text-white/50">
                {service.description}
              </p>
